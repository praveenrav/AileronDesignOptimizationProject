...
stall_coeff = 1.3; % Values ranging from 1.1 to 1.3 (1.3 was selected to account for maximum drag)
V_app = (stall_coeff * Vs)/1.94384; % Convert to m/s

drag_momarm_percentage = 0.4;

C_D_R = 0.95; % Rolling drag coefficient (uncertainty as it ranges from 0.8 to 1.1)
